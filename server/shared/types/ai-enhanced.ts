...
import { z } from 'zod';
import { PVPanel, Inverter, BatteryBank, ProtectionDevice, Wire, MountingHardware, BatteryBankSchema, ProtectionDeviceSchema, WireSchema, MountingHardwareSchema } from '.';
import { InverterSchema, PVPanelSchema } from '.';
...
export const EnhancedPVPanelSchema = PVPanelSchema.extend({
...
export const EnhancedInverterSchema = InverterSchema.extend({
  aiAttributes: z.object({
    ...AIEquipmentAttributesSchema.shape,
...
export const EnhancedBatteryBankSchema = BatteryBankSchema.extend({
  aiAttributes: z.object({
    ...AIEquipmentAttributesSchema.shape,
...
export const EnhancedProtectionDeviceSchema = ProtectionDeviceSchema.extend({
  aiAttributes: z.object({
    ...AIEquipmentAttributesSchema.shape,
...
// Enhanced Wire type
export const EnhancedWireSchema = WireSchema.extend({
  aiAttributes: z.object({
    ...AIEquipmentAttributesSchema.shape,
...
export const EnhancedMountingHardwareSchema = MountingHardwareSchema.extend({
  aiAttributes: z.object({
    ...AIEquipmentAttributesSchema.shape,

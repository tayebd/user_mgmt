...
const generateSampleData = (): KPI[] => {
  return [
    ...
    },
    {
      ...
      description: 'Tunisian companies with I4.0 strategy in business plan',
      value: 28.6,
      previousValue: 24.8,
      format: 'percentage',
      trend: 'up',
    ...
    },
    {
      ...
      description: 'Indirect processes (HR, Marketing, Accounting) digitization rate',
      value: 53.8,
      previousValue: 48.2,
      format: 'percentage',
      trend: 'up',
    ...
    {
      id: 'product-individualization',
      title: 'Product Individualization Level',

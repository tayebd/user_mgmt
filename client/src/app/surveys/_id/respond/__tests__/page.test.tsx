...
// Import from the actual component location
import RespondPage from '@/app/surveys/[id]/respond/page';
import * as apiStore from '@/state/api';
import { useRouter } from 'next/navigation';
import { toast } from 'sonner';

// Mock SurveyJS theme
jest.mock('@/app/surveys/[id]/respond/theme', () => ({
  themeJson: {
    checkbox: {
